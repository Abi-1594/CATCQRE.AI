...
import { Settings, AlertTriangle, Target, DollarSign } from "lucide-react"
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label className="text-sm font-medium">Action when stories exceeded</Label>
              <Select
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <Label className="text-sm font-medium">Max Square Footage</Label>
              <Input
                type="number"
                value={rules.maxSquareFootage}
                onChange={(e) => handleRuleChange("maxSquareFootage", Number.parseInt(e.target.value))}
                className="mt-1"
              />
            </div>
